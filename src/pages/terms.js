  ...
  return (
    <div className={cl.privacy}>
      ...
      <div>
        ...
        <p>
          Welcome to <b>Erzy Inc (“Company”, “we”, “our”, “us”)!</b> As you have
        ...
        <p>
          These Terms of Service<b>(“Terms”, “Terms of Service”)</b> govern your
          use of our web pages located at
          <a href="https://erzy.net">https://erzy.net</a> operated by Erzy Inc
        </p>
        <p>
        ...
        <p>
          ...
          info@erzy.net so we can try to find a solution. These Terms apply to
      ...
      <div>
        ...
        <p>
          ...
          renew under the exact same conditions unless you cancel it or Erzy Inc
          cancels it. You may cancel your Subscription renewal either through
          your online account management page or by contacting Erzy Inc customer
          support team.
        </p>
        <p>
          A valid payment method, including credit card, is required to process
          the payment for your subscription. You shall provide Erzy Inc with
          ...
          authorize Erzy Inc to charge all Subscription fees incurred through
          your account to any such payment instruments.
        </p>
        <p>
          Should automatic billing fail to occur for any reason, Erzy Inc will
      ...
      <div>
        <h2>6. Free Trial</h2>
        <p>
          Erzy Inc may, at its sole discretion, offer a Subscription with a free
        ...
        <p>
          ...
          Trial, you will not be charged by Erzy Inc until Free Trial has
        ...
        <p>
          At any time and without notice, Erzy Inc reserves the right to (i)
      ...
      <div>
        <h2>7. Fee Changes</h2>
        <p>
          Erzy Inc, in its sole discretion and at any time, may modify
        ...
        <p>
          Erzy Inc will provide you with a reasonable prior notice of any change
      ...
      <div>
        <h2>8. Refunds</h2>
        <p>
          We issue refunds for Contracts within sixty (60) days of the original
      ...
      <div>
        ...
        <p>
          Erzy Inc has the right but not the obligation to monitor and edit all
      ...
      <div>
        ...
        <p>
          ...
          property of Erzy Inc and its licensors. Service is protected by
          ...
          product or service without the prior written consent of Erzy Inc.
        </p>
      </div>
      <div>
        ...
        <p>
          ...
          to deni@erzy.net, with the subject line: “Copyright Infringement” and
      ...
      <div>
        ...
        <p>
          ...
          behalf of the owner of the copyright&apos;s interest; <br />
          ...
          <br />
          You can contact our Copyright Agent via email at deni@erzy.net
        </p>
      </div>
      <div>
        <h2>17. Error Reporting and Feedback</h2>
        <p>
          You may provide us either directly at info@erzy.net or via third party
      ...
      <div>
        ...
        <p>
          ...
          that are not owned or controlled by Erzy Inc
        </p>
        <p>
          Erzy Inc has no control over, and assumes no responsibility for the
        ...
        <p>
          YOU ACKNOWLEDGE AND AGREE THAT ERZY INC SHALL NOT BE RESPONSIBLE OR
