export const enUS = {
  ...
  faq: [
    ...
    {
      title:
        'What do I need to do to start earning from paid cross-promotions?',
...
export const enFR = {
  ...
  faq: [
    {
      title:
        'Сколько каналов могут участвовать одновременно во взаимном пиаре(ВП)?    ',
    ...
    {
      title:
        'Могу ли я проводить взаимный пиар(ВП) в групповых чатах Telegram или частных каналах?    ',
    ...
    {
      title:
        'Что мне нужно сделать, чтобы начать зарабатывать на платных ВП?    ',
    ...
    {
      title:
        'Что произойдет, если я удалю бота со своего канала во время взаимного пиара?    ',
    ...
    {
      title:
        'Есть ли способ монетизировать мой телеграм-канал с помощью Erzy?    ',
